...
% Kolumny AS, AU, AW, AY, BA.... 

function pradPojazduZPunktuWidzeniaPodstacjiTrakcyjnej = ustawPradPojazduZPunktuWidzenia_PT_n(lokalizacjaPojazduNaTrasieZTablicaRozkladJazdyWzorzec, lokalizacja_PT_n, Lokalizacja_PT_nPlusJeden, pradPojazduZTablicaRozkladJazdyWzorzec,arg_r_zast_sieciTrakcyjnej, arg_r_zast_szyn, arg_r_dodatkowe)
...
arg_r_dodatkowe=arg_r_dodatkowe/1000; %[ohm/m]
    ...
    if (lokalizacjaPojazduNaTrasieZTablicaRozkladJazdyWzorzec>=lokalizacja_PT_n) & (lokalizacjaPojazduNaTrasieZTablicaRozkladJazdyWzorzec<Lokalizacja_PT_nPlusJeden)
        ...
        Licznik_pradPojazduZPunktuWidzeniaPodstacjiTrakcyjnej=pradPojazduZTablicaRozkladJazdyWzorzec/((arg_r_zast_sieciTrakcyjnej+arg_r_zast_szyn+arg_r_dodatkowe)*(lokalizacjaPojazduNaTrasieZTablicaRozkladJazdyWzorzec-lokalizacja_PT_n));
