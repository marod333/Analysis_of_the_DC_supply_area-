% Program sluzy do obliczania tablicy drogi i pradu zasilacza z punktu widzenia Podstacji Trakcyjnej - PT_n
%                 drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica
%                  | 
%                  V
%     -->     <--  -->                  <--  -->     <--  
...
% z punktu widzenia PT_n

% Tablica nosi nazwe
% drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica
function drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica = ObliczTabliceDrogaPradZasilaczaZPunktuWidzenia_PT_n(indexLokalizacji_PT_n,indexLokalizacji_PT_nPlusJeden)

% clear drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica
...
drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica = zeros(liczbaWierszy_RozkaldJazdyTablica,liczbaKolumn_RozkaldJazdyTablica);
drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica(:,1:4) =  RozkaldJazdyTablica(:, 1:4);
    ...
    for indexKolumnyUzupelnianiaDrogi = 5:2:liczbaKolumn_RozkaldJazdyTablica
        for indexWierszaUzupelnianiaDrogi = 1:liczbaWierszy_RozkaldJazdyTablica
            drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica(indexWierszaUzupelnianiaDrogi,indexKolumnyUzupelnianiaDrogi)=...
                ustawPolozeniePojazduZPunktuWidzenia_PT_n(...
    ...
    for indexKolumnyUzupelnianiaPradu = 6:2:liczbaKolumn_RozkaldJazdyTablica
        for indexWierszaUzupelnianiaPradu = 1:liczbaWierszy_RozkaldJazdyTablica
            drogaPradZasilacza_PT_n_Tablica_zRozkladJazdyTablica(indexWierszaUzupelnianiaPradu,indexKolumnyUzupelnianiaPradu)=...
                ustawPradPojazduZPunktuWidzenia_PT_n(...
